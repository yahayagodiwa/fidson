...
const { createPost, getPosts, getPostById, editPosts, deletePosts } = require('../controller/blog.controller');
...
router.patch("/api/post/:id", [authMiddleware, isAdmin], editPosts);
router.delete("/api/post/:id", [authMiddleware, isAdmin], deletePosts);
